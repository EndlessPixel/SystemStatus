...
window.LANGUAGE_DATA['zh-CN'] = {
        ...
        procNet: "网络 ↓↑",
        gpuFreq: "频率",
        gpuHint: "为什么很多信息无法获取？部分硬件数据依赖底层命令或驱动：",
        gpuHintIntel: "Intel 核显使用率/频率/功耗：需 root 权限并安装 intel-gpu-tools（intel_gpu_top），请用 sudo 运行本程序",
        gpuHintNvidia: "NVIDIA 显存/温度/功耗：需安装 nvidia-ml-py（NVML）",
        gpuHintReadme: "更多权限与依赖说明请对照 README「Linux 权限说明」章节",
        settingLang: "语言",
        settingTheme: "主题",
        themeAuto: "跟随系统",
        themeLight: "浅色",
